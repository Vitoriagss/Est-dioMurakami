...
export function Segmentos() {
  return (
    <section
      id="segmentos"
      className="scroll-mt-28 min-h-screen bg-orange-50 flex flex-col items-center justify-center py-12 sm:py-16 lg:py-24"
    >
      <div className="container mx-auto flex flex-col items-center gap-10 lg:gap-16 px-4 sm:px-10 lg:px-16">
        <h2 className="font-(family-name:--font-playfair) text-3xl lg:text-5xl font-semibold text-black text-center">
          Segmentos
        </h2>
        ...
        <div className="flex flex-col items-center gap-4 w-full max-w-md">
          <h3 className="font-(family-name:--font-montserrat-sans) text-2xl lg:text-3xl font-semibold text-black text-center">
            Nos contate!
          </h3>
