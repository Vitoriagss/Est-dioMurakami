    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-branco rounded-2xl p-6 max-w-md w-full space-y-4 border border-bege">
        ...
        <div className="flex gap-3 justify-end pt-2">
          <button
            onClick={onClose}
            className="px-5 py-2 rounded-2xl border border-bege hover:bg-bege/30 transition-colors"
          >
            Voltar
          </button>
          <button
            onClick={onConfirm}
            className="px-5 py-2 rounded-2xl bg-vermelho text-white hover:opacity-90 transition-opacity"
          >
            Confirmar cancelamento
          </button>
        </div>
